...
export default function Info() {
  return (
    ...
    <p><strong>Hbadger is a utility and governance protocol built for long-term resilience.</strong> It is designed for participants who want more than speculation — those who value ownership, accountability, and systems that hold up under pressure.</p>
    ...
    <p>We’re not here to chase trends. We’re here to build what survives them.</p>
        ...
        <div className="InfTwo">
          <img src="/images/FInaleTorch.png" alt="" />
        </div>

        <div className="InfThree">
          <img src="/images/ResilientHbadger.png" alt="" />
          <img src="/images/Secure Hbadger.png" alt="" />
          <img src="/images/dontstopme.png" alt="" />
        </div>
      </div>
    </div>
  );
